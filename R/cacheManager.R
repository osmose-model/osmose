...
updateCache <- function(nameFile) {
  ...
  zip_urls <- list(
    ...
    "osmose_4.3.2-jar-with-dependencies.jar" = "https://github.com/osmose-model/osmose/releases/download/4.3.2/osmose-4.3.2-jar-with-dependencies.jar",
    "osmose_4.3.3-jar-with-dependencies.jar" = "https://github.com/osmose-model/osmose/releases/download/4.3.3/osmose-4.3.3-jar-with-dependencies.jar",
