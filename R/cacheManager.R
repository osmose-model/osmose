...
updateCache = function(nameFile) {
  ...
  zip_urls = list(
    ...
    "osmose-4.4.0-jar-with-dependencies.jar" = "https://github.com/osmose-model/osmose/releases/download/v4.4.0/osmose_4.4.0-jar-with-dependencies.jar",
    "osmose-4.4.1-jar-with-dependencies.jar" = "https://github.com/osmose-model/osmose/releases/download/v4.4.1/osmose-4.4.1-jar-with-dependencies.jar",
