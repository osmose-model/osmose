 ...
 * @author P. Verley
 */
public class ConstantLarvaMortality extends AbstractMortalitySpecies {
    ...
    @Override
    public void init() {
            Dlarva = getConfiguration().getDouble("mortality.additional.larva.rate.sp" + getFileSpeciesIndex());
    }
