 ...
 * @author pverley
 */
public class AgeDistribution extends AbstractDistribution {

    public AgeDistribution(int fileSpeciesIndex) {
        super(DistributionType.AGE, fileSpeciesIndex);
    }

    public AgeDistribution() {
        super(DistributionType.AGE);
    }
