...
public class AdditionalMortalityNDistribOutput_Netcdf extends AbstractDistribOutput_Netcdf {
    ...
    public AdditionalMortalityNDistribOutput_Netcdf(int rank, OutputDistribution distrib) {
        super(rank, distrib);
    }
    ...
    public void update() {
        for (School school : getSchoolSet().getAliveSchools()) {
            ...
            if (classSchool >= 0) {
                values[school.getFileSpeciesIndex()][getClass(school)] += school.getNdead(MortalityCause.ADDITIONAL);
            }
        }
    }
