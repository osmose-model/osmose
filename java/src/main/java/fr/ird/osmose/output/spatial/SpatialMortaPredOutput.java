 ...
 * @author pverley
 */
public class SpatialMortaPredOutput extends AbstractSpatialOutput {

    public SpatialMortaPredOutput(int rank) {
        super(rank);
    }
    ...
    public String getDesc() {
        return "Mean predation mortality, per species and per cell";
    }
                ...
                if (null != getSchoolSet().getSchools(cell)) {
                    for (School school : getSchoolSet().getSchools(cell)) {
                        ...
                        if (!school.isUnlocated()) {
                            ...
                            temp[iSpec][j][i] += school.getNdead(MortalityCause.PREDATION);
