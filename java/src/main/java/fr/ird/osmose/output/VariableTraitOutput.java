...
public class VariableTraitOutput extends SimulationLinker implements IOutput {
    ...
    public void init() {
        ...
        Dimension traitDim = bNc.addDimension("trait", this.getSimulation().getNEvolvingTraits());
        ...
        Variable.Builder<?> tvar = bNc.addVariable("time", DataType.FLOAT, "time");
        ...
        Variable.Builder<?> trait_mean_var = bNc.addVariable("trait_mean", DataType.FLOAT, outdim_l);
        ...
        Variable.Builder<?> specvar = bNc.addVariable("species", DataType.INT, "species");
        ...
        try {
             ...
             */
            ArrayInt.D1 arrTrait = new ArrayInt.D1(this.getSimulation().getNEvolvingTraits(), false);
            ArrayInt.D1 arrSpecies = new ArrayInt.D1(this.getNSpecies(), false);
