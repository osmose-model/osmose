...
public class AbundanceDistribOutput_Netcdf extends AbstractDistribOutput_Netcdf {
    ...
    public AbundanceDistribOutput_Netcdf(int rank, OutputDistribution distrib) {
        super(rank, distrib);
    }
    ...
    public void update() {
        for (School school : getSchoolSet().getAliveSchools()) {
            ...
            if (classSchool >= 0) {
                values[school.getFileSpeciesIndex()][classSchool] += school.getInstantaneousAbundance();
            }
        }
    }
