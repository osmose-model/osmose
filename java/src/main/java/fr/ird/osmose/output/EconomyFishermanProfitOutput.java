...
public class EconomyFishermanProfitOutput extends SimulationLinker implements IOutput {
    ...
    public EconomyFishermanProfitOutput(int rank) {
        super(rank);
    ...
    public void update() {
        ...
        for (int iSpecies = 0; iSpecies < getNSpecies(); iSpecies++) {
            output[iSpecies] += getSimulation().getEconomicModule().getFishermanProfit(iSpecies);
        }
    }
    ...
    public void init() {
        ...
        for (int iSpecies = 0; iSpecies < getNSpecies(); iSpecies++) {
            ...
            filename.append("_FishermanProfit");
            filename.append("-");
