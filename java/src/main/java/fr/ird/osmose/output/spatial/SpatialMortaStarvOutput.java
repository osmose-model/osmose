 ...
 * @author pverley
 */
public class SpatialMortaStarvOutput extends AbstractSpatialOutput {

    public SpatialMortaStarvOutput(int rank) {
        super(rank);
    }

    @Override
    public String getVarName() {
        return "Starvation mortality";
    }

    @Override
    public String getDesc() {
        return "Mean starvation mortality, per species and per cell";
    }
                ...
                if (null != getSchoolSet().getSchools(cell)) {
                    for (School school : getSchoolSet().getSchools(cell)) {
                        ...
                        if (!school.isUnlocated()) {
                            ...
                            temp[iSpec][j][i] += school.getNdead(MortalityCause.STARVATION);
                            abundance[iSpec][j][i] += school.getAbundance();
                        }
                    }
                }
            }
