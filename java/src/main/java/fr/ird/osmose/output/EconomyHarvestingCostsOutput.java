...
public class EconomyHarvestingCostsOutput extends SimulationLinker implements IOutput {
    ...
    public EconomyHarvestingCostsOutput(int rank) {
        super(rank);
    ...
    public void init() {
        ...
        for (int iSpecies = 0; iSpecies < getNSpecies(); iSpecies++) {
            ...
            filename.append("_HarvestingCosts");
