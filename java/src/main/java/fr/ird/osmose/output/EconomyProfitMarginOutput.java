...
public class EconomyProfitMarginOutput extends SimulationLinker implements IOutput {
    ...
    public EconomyProfitMarginOutput(int rank) {
        super(rank);
