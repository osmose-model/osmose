 ...
 */
public class BackgroundMapSet extends OsmoseLinker {
    ...
    public BackgroundMapSet(int iSpeciesFile, int iSpecies, String prefix) {
        this(iSpeciesFile, iSpecies, prefix, "map");
    }

    public BackgroundMapSet(int iSpeciesFile, int iSpecies, String prefix, String suffix) {
        this(iSpeciesFile, iSpecies, prefix, suffix, true);
    }

    public BackgroundMapSet(int iSpeciesFile, int iSpecies, String prefix, String suffix, boolean removeDuplicate) {
    ...
    public GridMap getMap(BackgroundSchool school, int iStepSimu) {
        return getMap(getIndexMap(school.getClassIndex(), iStepSimu));
    }
