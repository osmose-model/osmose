...
///////////////////////////////
     ...
     */
    private final FilteredSet<BackgroundSchool> schoolset;
    /**
     * Snapshot of the distribution of the schools on the grid.
     */
    private final HashMap<Integer, List<BackgroundSchool>> schoolByCell;
    /**
     ...
     */
    private final HashMap<Integer, List<BackgroundSchool>> schoolBySpecies;
    /**
    ...
    public BackgroundSchoolSet() {
        schoolset = new FilteredSet<>();
        schoolBySpecies = new HashMap<>();
        schoolByCell = new HashMap<>();
        hasSpeciesChanged = new boolean[getConfiguration().getNBkgSpecies()];
...
///////////////////////////////
     ...
     */
    public void add(BackgroundSchool school) {
     ...
     */
    public List<BackgroundSchool> getSchools() {
        return schoolset;
    }
     ...
     */
    public List<BackgroundSchool> getSchools(ISpecies species, boolean update) {
     ...
     * @return a list of schools of this {@code species}
     */
    public List<BackgroundSchool> getSchools(ISpecies species) {
     ...
     */
    public List<BackgroundSchool> getPresentSchools() {
    ...
    //  * step.
    //  */
    // public List<BackgroundSchool> getOutSchools() {
    ...
    //  */
    // public List<BackgroundSchool> getAliveSchools() {
    ...
    //  */
    // public List<BackgroundSchool> getOldSchools() {
    ...
    public void updateSchoolMap() {
        ...
        // Clear the map
        for (List<BackgroundSchool> schools : schoolByCell.values()) {
            schools.clear();
        }

        // Fill up the map
        for (BackgroundSchool school : schoolset) {
