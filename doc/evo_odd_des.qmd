...
and assumptions of the Evolutinoary version (EVO-OSMOSE) version of the OSMOSE model, apply it to a specific case study and run simulations for addressing
specific issues.

% The OSMOSE model aims at exploring fish community dynamics and the
...
evo_odd_des/design_concepts.md
evo_odd_des/init.md
evo_odd_des/submodel.md
```
