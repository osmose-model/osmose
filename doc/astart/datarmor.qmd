...
This section describes the easiest way to install Osmose on the Datarmor HPC.
...
When this is done, type the following:
...
:::{.callout-tip}
To make Conda permanently available, you can add the line `source /appli/anaconda/latest/etc/profile.d/conda.csh` to the `~/.cshrc`
file
:::
