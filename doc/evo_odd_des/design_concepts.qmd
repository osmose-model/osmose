...
Phenotypic values of schools’ evolving traits- maximum ingestion rate $I_{max}$ , gonado-somatic index $r$ , intercept
and slope  of the maturation reaction norm
$m_0$ and $m_1$- are entirely determined by their genotype and randomly drawn expression noise. In contrast,
other individual variables or traits at higher integrative levels of organization (hereafter named "emerging variables":
somatic mass $w(i,t)$ , length $L(i,t)$ , gonadic mass $g(i,t)$  and thus fecundity $N_{eggs}(i,t)$ ,
maturation age $a_m(i)$
and somatic mass or length at maturation $w_m(i)$ and $L_m(i)$) as well as starvation mortality
