...
To install the library on a Windows system, first download and install the HDF5 library from the [HDF5 website](https://www.hdfgroup.org/downloads/hdf5/).

Then download and install the NetCDF library from the [Unidata website](https://www.unidata.ucar.edu/software/netcdf/docs/winbin.html)
