...
The mobilized energy $E_M$ fuels all metabolic processes starting in priority with the costs of maintenance of existing tissues $E_m$,
...
The maintenance
energy rate $E_m$ scales with individual’s somatic mass $w(i,t)$ with the same exponent as maximum ingestion rate. Thus, for a given
...
also increases with the temperature $T(i,t)$ experienced by individuals {cite}`gillooly2002effects` and can be described as
