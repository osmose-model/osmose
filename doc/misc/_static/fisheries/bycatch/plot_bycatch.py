...
data = pd.read_csv("misc/_static/fisheries/bycatch/fishingMatrix.csv", index_col=0)
...
plt.savefig('misc/_static/fisheries/bycatch/plot_bycatch.png', bbox_inches='tight')
