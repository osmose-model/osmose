...
| -------------- | ------------------------------------------------------- | ------------------------------------------------------ | ------ |
| i_step_simu    |  Times step of the simulation                           |  int, $\in [0, N_{year} \times N_{step\_year}]$        |        |
...
: Simulation state variables {#tbl-sim-statevar .hover .striped tbl-colwidths="[40,40,10, 10]"}