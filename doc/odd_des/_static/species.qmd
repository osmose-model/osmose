...
| index                |  index of the species                             |  int, :math:`\in[0, N_{species} - 1]` |             |
| fileIndex            |  index of the species in the configuration file   |  int, :math:`>0`                      |             |
| lifespan             |  species life span                                |  int, :math:`>0`                      |  time-steps |
...
| TL_EGG               |  egg trophic level                                |  float, :math:`= 3.0`                 |             |
