...
| index            |  Species index.                                                      |  int, :math:`\in [N_{species}, N_{species} + N_{bkgspecies}] - 1`  |            |
| fileindex        |  index of the species in the                                         |  int, :math:`>0`                                                   |            |
...
| nClass           |  Number of size-classes                                              |  int, :math:`>1`                                                   |            |
