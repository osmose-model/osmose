...
```{index} single: growth.exponential.lstart.sp# single: growth.exponential.ke.sp# single: growth.gompertz.linf.sp# single: growth.gompertz.kg.sp# single: growth.gompertz.tg.sp# single: growth.exponential.thr.age.sp# single: growth.gompertz.thr.age.sp#
```
