...
data = pd.read_csv("submodel/mort/_static/fisheries/bycatch/fishingMatrix.csv", index_col=0)
...
plt.savefig('submodel/mort/_static/fisheries/bycatch/plot_bycatch.svg', bbox_inches='tight')
